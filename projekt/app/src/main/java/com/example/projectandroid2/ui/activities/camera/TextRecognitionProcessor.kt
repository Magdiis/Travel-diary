...
import com.example.projectandroid2.mlkit.VisionProcessorBase
...
class TextRecognitionProcessor(
    ...
    // PreferenceUtils.showLanguageTag(context)
    private val showConfidence: Boolean = true
    //PreferenceUtils.shouldShowTextConfidence(context)
...
//    )
    ...
    override fun onFailure(e: Exception) {
        ...
        onTextFoundListener.onFailure(exception = e)
    }
